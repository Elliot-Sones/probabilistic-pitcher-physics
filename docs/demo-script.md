...
> The GMM learns the shape of the pitcher's distribution. Monte Carlo sampling turns that learned shape into actual pitch targets Trajekt could throw.
